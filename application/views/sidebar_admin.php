        ...
        <div class="container mx-auto my-3 py-2 flex flex-col lg:flex-row justify-between items-center">
            ...
            <div id="menu" class="hidden lg:flex lg:items-center">
                <ul class="flex flex-col lg:flex-row lg:ml-auto">
                    <li>
                        <button class="px-4 py-2 text-white hover:text-green-500" onclick="navigateTo('<?= base_url('admin') ?>')">Dashboard</button>
                    </li>
                    <li>
                        <button class="px-4 py-2 text-white hover:text-green-500" onclick="navigateTo('<?= base_url('admin/public') ?>')">Public</button>
                    </li>
                    <li>
                        <button class="px-4 py-2 text-white hover:text-green-500" onclick="navigateTo('<?= base_url('admin/pesan') ?>')">Pesan</button>
                    </li>
                    <li>
