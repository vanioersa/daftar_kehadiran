...
<body>
    ...
    <?php foreach ($user as $row) : ?>
        <div class="container mx-auto my-10 bg-blue-100 rounded-sm sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-full p-6 shadow-md">
            ...
            <form method="post" action="<?= base_url('user/aksi_ubah_profile'); ?>" enctype="multipart/form-data">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" placeholder="Masukkan Nomor" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500" id="nomor" name="nomor" value="<?= $row->nomor; ?>">
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div class="mb-4">
                        <label for="foto" class="block text-sm font-medium text-gray-600">Pilih Foto</label>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="jenis_kelamin" id="jenis_kelamin" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500">
            ...
            <form method="post" action="<?= base_url('user/aksi_ubah_password'); ?>" class="mt-6" id="ubahPasswordForm">
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <button class="btn btn-outline-secondary absolute top-6 transform -translate-y-1/2 right-3" type="button" id="togglePasswordLama" onclick="togglePassword('password_lama', 'togglePasswordLama')">
                ...
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <button class="btn btn-outline-secondary absolute top-6 transform -translate-y-1/2 right-3" type="button" id="togglePasswordBaru" onclick="togglePassword('password_baru', 'togglePasswordBaru')">
                            <i class="fas fa-eye-slash"></i>
                        </button>
                    </div>
                </div>
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <button class="btn btn-outline-secondary absolute top-6 transform -translate-y-1/2 right-3" type="button" id="toggleKonfirmasiPassword" onclick="togglePassword('konfirmasi_password', 'toggleKonfirmasiPassword')">
                            <i class="fas fa-eye-slash"></i>
                        </button>
                    </div>
                </div>
