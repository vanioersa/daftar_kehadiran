...
<body>
    ...
    <a href="<?php echo base_url('admin/tambah_card_public') ?>" class="ml-2 mx-10 mt-5 inline-block px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold text-base rounded">
