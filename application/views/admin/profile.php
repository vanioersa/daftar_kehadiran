        ...
        <div class="container mx-auto my-10 bg-blue-100 rounded-sm sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-full p-6 shadow-md">
            <div class="text-center">
                <?php if (!empty($row->image)) : ?>
                    <img src="<?= base_url('./image/' . $row->image) ?>" class="mx-auto mt-4 mb-2 object-cover w-52 h-48 rounded-full" alt="Profile Image">
                <?php else : ?>
            ...
            <form method="post" action="<?= base_url('admin/aksi_ubah_profile'); ?>" enctype="multipart/form-data">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" autocomplete="off" id="nama" name="nama" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500" value="<?= $row->nama; ?>">
                    </div>
